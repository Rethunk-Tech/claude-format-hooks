...
// subcommand for .tf, .tfvars, .tftest.hcl, .tfmock.hcl, and .tfquery.hcl —
// Terraform/HCL has no Go equivalent invokable in-process without vendoring
// HashiCorp's own hclwrite package, and
