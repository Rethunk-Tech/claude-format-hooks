...
Describe how you validated the change (for example
`go test -race -cover ./...`, running `format-dispatch` manually against a
sample file, specific extensions/formatters exercised).
